  ...
  return(
    <div className="page-width mt-10
      ...
      <div className="hidden xl:inline-block col-start-1 text-right self-end mr-3">
        <p className="text-sm text-[var(--color-text-header-secondary)] font-jetbrains pr-4 pb-1">
          &lt;h1 data-lang='
      ...
      <div className="col-start-1 xl:col-start-2 mx-auto xl:ml-0 md:min-w-[800px]">
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-inter font-black text-[var(--color-text-header-primary)] sm:mb-6 md:mb-8 lg:mb-10">I'm 
        ...
        <div className="flex flex-wrap">
          <h1 className="inline-block sm:hidden text-5xl md:text-7xl font-inter font-extrabold text-[var(--color-text-header-primary)] whitespace-nowrap">a web developer
            <span className="text-4xl -ml-1">.</span>
          </h1>
          <span className="whitespace-nowrap">
            <h1 className="hidden sm:inline-block text-6xl md:text-7xl font-inter font-extrabold text-[var(--color-text-header-primary)]">Full stack developer
