...
export default function NavLinks() {
  ...
  return(
    <ul className="flex md:gap-1 xl:gap-2 justify-end items-center">
      ...
      <a href="https://www.linkedin.com/in/jamesbkemp" target="_blank" rel="noopener">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="size-7 sm:size-8
          text-[var(--color-socials)] hover:text-[hsl(from_var(--color-socials)_h_s_calc(l*0.85))] hover:cursor-pointer">
      ...
      <a href="https://github.com/jbk2" target="_blank" rel="noopener">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="size-7 sm:size-8
          text-[var(--color-socials)] hover:text-[hsl(from_var(--color-socials)_h_s_calc(l*0.85))] hover:cursor-pointer">
      ...
      <a href="https://www.x.com/jbkemp" target="_blank" rel="noopener">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="size-7 sm:size-8
          text-[var(--color-socials)] hover:text-[hsl(from_var(--color-socials)_h_s_calc(l*0.85))] hover:cursor-pointer">
