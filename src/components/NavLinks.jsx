...
import { MyBlogSvgLight, MyBlogSvgDark } from './icons/Icons';
...
export default function NavLinks() {
  ...
  return(
    <ul className="flex md:gap-1 xl:gap-2 justify-end items-center">
      ...
      {/* <a href="https://www.dev.to/jbk2" target="_blank" rel="noopener"
        className='text-2xl'>
        <p className="filter grayscale">📝</p>
      </a> */}
      ...
      <a href="https://www.dev.to/jbk2" target="_blank" rel="noopener" title="My Blog Link">
        { dataTheme == 'dark' ? <MyBlogSvgDark /> :  <MyBlogSvgLight /> }
      </a>
    </ul>
  )
}